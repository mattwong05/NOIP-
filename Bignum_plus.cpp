...
//  初始化
Bignum::Bignum(int val, int base_it = 10){
    if(val >= 0){
        tag = true;
    }
    else{
...
Bignum::Bignum(string val, int base_it = 10){
    tag = true;
    base = base_it;
...
int main(void){
    ...
    //  其他进制的计算
    Bignum A_base16("AAAAA", 16), B_base16("11111", 16);
    A_base16.print(1);
    B_base16.print(1);
    (A_base16 + B_base16).print(1); //  BBBBB
    system("pause");
    return 0;
}
